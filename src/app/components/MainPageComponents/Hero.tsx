...
const Hero = ({ url }: urlProps) => {
    ...
    return (
        <main className="h-screen w-full bg-red-300 relative">
            <video className="w-full h-full absolute object-cover z-10 opacity-90" autoPlay muted loop src={isMobile ? url[0] : url[1]} />
            <div className='relative z-20 text-white flex justify-center h-full w-full flex-col max-w-4xl mx-auto gap-10'>
                <h1 className='text-6xl font-bold'>Indonesia's leading mobile app development agency</h1>
