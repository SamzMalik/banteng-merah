    ...
    return (
        <div className='text-primary-white flex flex-col lg:h-[612px] justify-center gap-6 bg-blue-500 rounded-xl px-4'>
            <div className='flex gap-4'>
                <div className=' p-4 rounded-xl mx-auto'>
                    ...
                    <ul className='flex gap-4 mt-4'>
                        ...
                        <li className='p-2 bg-primary-white rounded-md text-primary-black flex flex-col items-center justify-center'>
                            <Image alt='something' width={44} height={44} src='/Swift_icon.webp' />
                            <p className='font-bold'>Swift</p>
                        </li>
                        <li className='p-2 bg-primary-white rounded-md text-primary-black flex flex-col items-center justify-center'>
                            <Image alt='something' width={44} height={44} src='/flutter.webp' />
            ...
            <div className='max-w-4xl self-center text-center flex flex-col items-center p-4'>
                ...
                <Image alt='software method' width={224} height={224} src='/software-dev-method.webp' />
