    ...
    return (
        <main className="w-full overflow-hidden">
            <div className="h-screen relative">
                <div className="h-2/3 flex items-center justify-center relative">
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center gap-6">
                        ...
                        <motion.h1 initial={{ opacity: 0, scale: 2 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.5 }} className="text-6xl font-bold text-primary-white text-center">We are Bantengs</motion.h1>
                    </div>
                </div>
                <motion.div initial={{ scale: 0, opacity: 0 }} transition={{ duration: 1, delay: 1 }} whileInView={{ scale: 1, opacity: 100 }} viewport={{ once: true }} className="flex items-center justify-center h-1/3">
            ...
            <div className="lg:h-[80vh] bg-primary-black flex flex-col justify-center items-center p-2 py-5 text-center lg:text-left">
                <motion.div initial={{ x: isMobile ? -300 : -500, opacity: 0, }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 2 }} className="container mx-auto flex flex-col text-primary-white gap-6 max-w-4xl text-xl">
